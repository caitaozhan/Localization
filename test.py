...
def test_ipsn_homo():
    ...
    selectsensor.init_data('data64/homogeneous/cov', 'data64/homogeneous/sensors', 'data64/homogeneous/hypothesis')
    # CPU version
    ...
    results = selectsensor.select_offline_greedy_lazy_gpu(40, 12, o_t_approx_kernal2)
    for r in results:
        print(r)
